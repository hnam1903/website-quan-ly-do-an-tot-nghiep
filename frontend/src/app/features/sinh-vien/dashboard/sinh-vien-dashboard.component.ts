...
import { DeTaiResponse, ApiResponse, DiemHuongDanResponse, DiemPhanBienResponse } from '../../../core/models/models';
...
export class SinhVienDashboardComponent implements OnInit {
  ...
  canDangKyDeTai(): boolean {
    return this.deTai === null;
  }
